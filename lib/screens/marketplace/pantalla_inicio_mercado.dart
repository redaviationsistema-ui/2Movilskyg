...
import '../cliente/pantalla_espacio_movil_cliente.dart';
import '../sobrecargo/pantalla_espacio_sobrecargo.dart';
import '../shared/widgets/contenedor_espacio_rol.dart';
import 'views/vistas_mercado_admin.dart';
import 'views/vistas_mercado_proveedor.dart';
  ...
  Widget build(BuildContext context) {
    switch (role) {
      ...
      case AppUserRole.crew:
        return const CrewWorkspaceScreen();
